...
public class CameraController : MonoBehaviour
{
    ...
    //        Zoom += Wheel;
    //        camera.orthographicSize = defaultOrtSize * Mathf.Pow(2, (Zoom) * -1);
    //        translation = new Vector3(Camera.main.ScreenToViewportPoint(Input.mousePosition).x, Camera.main.ScreenToViewportPoint(Input.mousePosition).y, 0);
    ...
    //        //}
    //        //else if (Wheel < 0 && Zoom + Wheel >= 0)// MaxWidht * 2 * (1 - MaxUp))
    //        //{
    //        //    Zoom += Wheel;
    //        //    camera.orthographicSize = defaultOrtSize * Mathf.Pow(2, (Zoom) * -1);
    //        //    translation = new Vector3(Camera.main.ScreenToWorldPoint(Input.mousePosition).x, Camera.main.ScreenToWorldPoint(Input.mousePosition).y, 0);
    //        //}
    //        cameraCorrect(translation * MaxDragSpeed * Time.deltaTime);
